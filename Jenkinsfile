        ...
        stage('Build Docker Image') {
            steps {
              script {
                    ...
                    sh "docker tag nginxreact:${VERSION} ashcoder666/learn_docker:nginxreact "
                    sh "docker push ashcoder666/learn_docker:nginxreact "
                }
            }
        }
        ...
        stage('Deploy Container') {
            steps {
                script {
                    ...
                    sh 'docker run -p 3000:80 ashcoder666/learn_docker:nginxreact'
                }
            }
        }
    }
